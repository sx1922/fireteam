...
return {
    ...
    ui_mm_squad            = "小队管理",
    ui_mm_squad_desc       = "查看队伍 · 标记就绪 · 加入小队",
    ui_mm_class            = "职业选择",
    ui_mm_class_desc       = "切换职业 · 查看装备与能力",
    ui_mm_backpack         = "网格背包",
    ui_mm_backpack_desc     = "管理装备 · 拖拽整理物品",
    ui_mm_tacmap           = "战术地图",
    ui_mm_tacmap_desc      = "查看战场 · 放置路点标记",
    ui_mm_command          = "指挥视图",
    ui_mm_command_desc     = "全阵营态势 · 队伍情况",
    ui_mm_admin            = "管理面板",
    ui_mm_admin_desc       = "服务器配置 · 回合管理",
